...
//buttons
let btnShowAll = document.querySelector("#All")
let btnShowKoreanFoods = document.querySelector("#Korea")
let btnShowJapanFoods = document.querySelector("#Japan")
let btnShowChineeseFoods = document.querySelector("#China")

//show all the foods under the All category button clicked!
btnShowAll.addEventListener("click", showAllFoods)
...
btnShowKoreanFoods.addEventListener("click",koreanCategory)
...
btnShowJapanFoods.addEventListener("click",japanCategory)
...
btnShowChineeseFoods.addEventListener("click", chinaCategory)